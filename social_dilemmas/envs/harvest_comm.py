...
from social_dilemmas.envs.agent import HarvestCommAgent
...
class HarvestCommEnv(MapCommEnv):
    ...
    @property
    def physical_action_space(self):
        agents = list(self.agents.values())
        return agents[0].action_space.u

    @property
    def communication_action_space(self):
        agents = list(self.agents.values())
        return agents[0].action_space.c
    ...
    def setup_agents(self):
        ...
        for i in range(self.num_agents):
            ...
            agent = HarvestCommAgent(agent_id, spawn_point, rotation, grid)
